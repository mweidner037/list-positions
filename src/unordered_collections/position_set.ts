...
import { OutlineSavedState } from "../lists/outline";
 ...
 * See the [ListCrdt implementation](https://github.com/mweidner037/list-positions-crdts/blob/master/src/list_crdt.ts)
 * in @list-positions/crdts for sample code.
 */
